...
//  Accelerate
  ...
  char textbuf[30];
  sprintf( textbuf, "[%s]",       getVitaButtonName(bindings::player1.throttleUp) );
...
//  Turn left
  ...
  sprintf( textbuf, "[%s]",       getVitaButtonName(bindings::player1.turnLeft) );
...
//  Turn right
  ...
  sprintf( textbuf, "[%s]",       getVitaButtonName(bindings::player1.turnRight) );
  draw_text( textbuf,             0.600f, 0.250f );


//  Decelerate
  draw_text( "Decelerate      ",  0.200f, 0.250f );
  sprintf( textbuf, "[%s]",       getVitaButtonName(bindings::player1.throttleDown) );
  draw_text( textbuf,             0.200f, 0.300f );


//  Fire
  draw_text( " Fire           ",  0.125f, 0.350f );
  sprintf( textbuf, "[%s]",       getVitaButtonName(bindings::player1.fire) );
  draw_text( textbuf,             0.275f, 0.350f );


//  Jump
  draw_text( "Eject           ",  0.125f, 0.400f );
  sprintf( textbuf, "[%s]",       getVitaButtonName(bindings::player1.jump) );

...
//  Accelerate
  ...
  char textbuf[30];
#ifdef VITA_PLATFORM
  sprintf( textbuf, "[%s]",       getButtonName(bindings::player1.throttleUp) );
#else
  sprintf( textbuf, "[%s]",       SDL_GetScancodeName(bindings::player1.throttleUp) );
#endif
...
#ifdef VITA_PLATFORM
  sprintf( textbuf, "[%s]",       getButtonName(bindings::player1.turnLeft) );
#else
  sprintf( textbuf, "[%s]",       SDL_GetScancodeName(bindings::player1.turnLeft) );
#endif
...
#ifdef VITA_PLATFORM
  sprintf( textbuf, "[%s]",       getButtonName(bindings::player1.turnRight) );
#else
  sprintf( textbuf, "[%s]",       SDL_GetScancodeName(bindings::player1.turnRight) );
#endif
...
#ifdef VITA_PLATFORM
  sprintf( textbuf, "[%s]",       getButtonName(bindings::player1.throttleDown) );
#else
  sprintf( textbuf, "[%s]",       SDL_GetScancodeName(bindings::player1.throttleDown) );
#endif
...
#ifdef VITA_PLATFORM
  sprintf( textbuf, "[%s]",       getButtonName(bindings::player1.fire) );
#else
  sprintf( textbuf, "[%s]",       SDL_GetScancodeName(bindings::player1.fire) );
#endif
...
#ifdef VITA_PLATFORM
  sprintf( textbuf, "[%s]",       getButtonName(bindings::player1.jump) );
#else
  sprintf( textbuf, "[%s]",       SDL_GetScancodeName(bindings::player1.jump) );
#endif
